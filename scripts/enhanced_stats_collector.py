...
class EnhancedStatsCollector:
    ...
    def get_pitcher_enhanced_stats(self, pitcher_id):
        ...
        try:
            ...
            # ===== MLB API seasonAdvanced から GB%/FB%/SwStr%/BABIP/QS を取得 =====
    ...
    def _get_advanced_stats(self, pitcher_id, season):
        """MLB API seasonAdvancedから詳細統計を取得（QS含む）"""
        try:
            url = f"{self.client.base_url}/api/v1/people/{pitcher_id}/stats"
            params = {
                        ...
                        if stat_group.get('splits'):
                            ...
                            if balls_in_play > 0:
                                ...
                                return {
                                    ...
                                    'babip': babip,
                                    'quality_starts': int(quality_starts) if quality_starts is not None else None
                                }
                            else:
                                # balls_in_playが0の場合でもQSは返す
                                return {
                                    'gb_percent': '0.0',
                                    'fb_percent': '0.0',
                                    'swstr_percent': '0.0',
