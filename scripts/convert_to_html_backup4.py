        ...
        <div class="header-section">
            ...
            <div class="team-info">
                ...
                <div class="team-details">
                    ...
                    <div class="pitcher-info-header">
                        <span class="pitcher-name-header">{game_data['away_data'].get('pitcher_name', '未定')}</span>
                        {f'<span class="pitcher-record-header">{game_data["away_data"].get("pitcher_record", "")}</span>' if game_data['away_data'].get('pitcher_record') else ''}
                        {f'<span class="pitcher-badge {'right-hand' if away_hand == 'R' else 'left-hand'}">{'右投' if away_hand == 'R' else '左投'}</span>' if game_data['away_data'].get('pitcher_name') != '未定' else ''}
                    </div>
                </div>
            </div>
            ...
            <div class="team-info">
                ...
                <div class="team-details">
                    ...
                    <div class="pitcher-info-header">
                        <span class="pitcher-name-header">{game_data['home_data'].get('pitcher_name', '未定')}</span>
                        {f'<span class="pitcher-record-header">{game_data["home_data"].get("pitcher_record", "")}</span>' if game_data['home_data'].get('pitcher_record') else ''}
                        {f'<span class="pitcher-badge {'right-hand' if home_hand == 'R' else 'left-hand'}">{'右投' if home_hand == 'R' else '左投'}</span>' if game_data['home_data'].get('pitcher_name') != '未定' else ''}
                    </div>
                </div>
            </div>
        </div>
